    ...
    <section className="bg- bg-white text-[#1D1D1D] py-8">
      <div className="max-w-[1180px] w-[100%] mx-auto">
        <div>
          ...
          <p className="my-3">
            This Privacy Policy describes how Just Meats (the "
            ...
            purchase from www.justmeats.com (the "<strong>Site</strong>") or
          ...
          <p>
            <ul className="list-disc ">
              ...
              <li className="mb-3">
                ...
                example, when sending a message through the Services. Some
                features of the Services may require you to directly provide us
                with certain information about yourself. You may elect not to
                provide this information, but doing so may prevent you from
                using or accessing these features.
              </li>
            </ul>
          </p>
          <h2 className="font-Roboto text-[42px]  font-medium  mb-3">
          ...
          <p>
            <ul className="list-disc ">
              ...
              <li className="mb-3">
                ...
                provided to us by third parties and are not responsible for any
                third party's policies or practices. For more information, see
          ...
          <p>
            <ul className="list-disc ">
              ...
              <li className="mb-3">
                ...
                our users or others. We have, in the past 12 months disclosed
                the following categories of personal information and sensitive
                personal information (denoted by *) about users for the purposes
          ...
          <p>
            <ul className="list-disc ">
              ...
              <li className="mb-3">
                ...
                may have a right to direct us not to "sell" or "share" your
                ...
                that if you visit our Site with the Global Privacy Control
                opt-out preference signal enabled, depending on where you are,
                we will automatically treat this as a request to opt-out of the
                "sale" or "sharing" of information for the device and browser
              ...
              <li className="mb-3">
                ...
                where indicated on our Site or by contacting us using the
          ...
          <p className="my-3">
            ...
            restrict Shopify merchants that use these ad services from using
            your personal information for such services, visit{' '}
          ...
          <p className="my-3">
            ...
            available to you, please call 343-1242 or email us at
            support@justmeats.com or contact us at 676 W 1200 N, Springville UT
            84663, United States.
          </p>
        </div>
      </div>
