...
export const DoMeatRight = () => {
  return (
    <section className="bg-[#efeeed] sm:pt-[10px]  sm:pb-[25px]  pb-[32px] relative" style={{ overflowX: "clip" }}>
      <div className="container-1120 z-50 relative w-[90%] sm:w-[80%] mx-auto">
        ...
        >
          ...
          <div className="text-[#EFEEED] font-dunbar uppercase mt-2 px-3 sm:flex sm:text-[36px] sm:text-left text-center text-[24px] font-bold sm:mb-[4px] mb-[3px] leading-normal tracking-[1.8px] ">
    ...
    <div className='relative z-50 pt-12'>
        <div className='font-dunbar uppercase sm:mt-8 mt-2 pb-8 text-[24px] sm:text-[36px] text-center  font-bold sm:mb-[4px] mb-[3px] leading-normal tracking-[1.8px]'>YOU ASK. WE ANSWER.</div>
