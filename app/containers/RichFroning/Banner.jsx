    ...
    <section className="relative sm:h-[calc(100vh-120px)] flex flex-col">
      ...
      <div className="font-nunito text-[#EFEEED]">
        <div className="bg-[#231b19] py-[10px] text-[15px] leading-[33px] tracking-[3px] font-normal overflow-x-hidden">
          <div className="container flex justify-between sm:gap-0 gap-[67px]">
            <div>FAMILY</div>
            <div>FITNESS</div>
            <div>FAITH</div>
            <div>SERVICE</div>
        ...
        <div className="bg-[#7A392D] sm:pt-[50px] sm:pb-[50px] pt-[44px] pb-[55px] grid sm:grid-cols-3 grid-cols-1 sm:gap-0 gap-[38px]">
