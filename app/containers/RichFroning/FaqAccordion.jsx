  ...
  return (
    <>
      <Accordion open={open === 1} icon={<Icon id={1} open={open} />} className="mb-2 rounded-lg border border-blue-gray-100 bg-[#fff] sm:px-8 pl-[25px] pr-[15px]">
        ...
        <AccordionBody className="pt-0 font-nunito text-lg font-normal leading-[27px] text-[#231B19] pr-9 pb-10">
      ...
      <Accordion open={open === 8} icon={<Icon id={8} open={open} />} className="mb-2 rounded-lg border border-blue-gray-100 bg-[#fff] sm:px-8 pl-[25px] pr-[15px]">
        ...
        <AccordionBody className="pt-0 font-nunito text-lg font-normal leading-[27px] text-[#231B19] pr-9 pb-10">
        All sealed meats can be stored in the refrigerator for 10-14 days upon arrival. Once the package is opened, we recommend consuming the refrigerated meat within 3-5 days. If this timeline will not work, all meats can be stored in the freezer for 4-6 months.
        </AccordionBody>
      </Accordion>
    </>
  );
