...
export const EarnAnywhere = () => {
  return (
    <>
            <section className='bg-[#121315] absolute w-full'>
    <div
    className="flex flex-col items-center bg-[#B19630] w-[90%] md:w-[80%] mx-auto text-white left-0
                pt-[21px] pb-[18px] rounded-[6px] xl:-mt-[90px] lg:-mt-[70px] md:-mt-[60px] -mt-[40px]"
  ...
  >
    <div className="text-center text-[23px] lg:text-[36px]  xl:text-[40px] 2xl:text-[48px] font-bold mb-[3px] leading-tight px-4 sm:mb-[4px]">
      EARN ANYWHERE FROM
      <span className="text-[#121315] ml-[6px] sm:ml-[8px]">
        $5K - $10K
      </span>
    </div>
    ...
    <div className="text-[14px] lg:text-[14px] text-center tracking-[3px] leading-[23px] text-[#ccbdb1]">
      ...
      <div className='bg-[#121315] h-[225px] sm:h-[125px]'></div>
    </>
