...
const OrderHistory = ({order}) => {
    ...
    const {shipping_address,line_items,total_price,total_discounts,subtotal_price,shipping_lines,status,external_order_id} = order;
    ...
    <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-[30px] text-center md:text-start">
        ...
        <div className='basis-6/12'>
            <div className='text-start'>
                        ...
                        <h5 className='capitalize text-[18px] font-medium '>Bundle Subscription</h5>
               
               
               
                
                <p className='capitalize font-normal leading-8 text-[16px]'>{line_items.length} meats</p>

                {line_items.length && line_items.map(item=>(
        ...
        <div className='basis-2/12'>
            <div className='text-start'>
                ...
                <p className='capitalize font-normal leading-8 text-[16px]'>{shipping_address.first_name} {shipping_address.last_name}</p>
                <p className='capitalize font-normal leading-8 text-[16px]'>{shipping_address.address1}</p>
                <p className='capitalize font-normal leading-8 text-[16px]'>{shipping_address.address2}</p>
                <p className='capitalize font-normal leading-8 text-[16px]'>{shipping_address.city}</p>
                <p className='capitalize font-normal leading-8 text-[16px]'>{shipping_address.zip}</p>
                <p className='capitalize font-normal leading-8 text-[16px]'>{shipping_address.province}</p>
            </div>
        </div>
