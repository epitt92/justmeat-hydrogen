        ...
        <div className="w-[85%] mx-auto">
            <div className='mx-auto mt-4 grid max-w-lg gap-8 lg:max-w-none lg:grid-cols-3 justify-center items-center'>
                <div className='text-center md:text-start'>
                    <h3 className='text-[50px] font-Roboto font-extrabold'>THE<br/> UltiMEAT<br/>EXPERIENCE</h3>
                </div>
                <div className='text-center md:text-start'>
                    <p className='mb-8 font-Roboto font-normal'>100% MEAT • NO ADDED COLORS OR FLAVORS Make the easiest, most delicious choice of your life and leave the protein to the pros (yes, that’s us!).</p>
